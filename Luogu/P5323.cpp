...
const modint inv100 = qPow(100, mod - 2);
const int maxn = 5e5 + 5;
int n;

il modint inv(modint n) {return qPow(n, mod - 2);}

int main() {
    read(n);
    modint f, g; read(f, g), f *= inv100, g *= inv100;
    FOR(i, 2, n) {
        modint a, b; read(a, b), a *= inv100, b *= inv100;
        f = a * f * inv(1 - g * b);
        g = b + a * a * g * inv(1 - b * g);
    }
    print(f);
